    ...
    <main>
        ...
        <section class="chats-dashboard">
            ...
            <div id="wishlist-information">
                ...
                <div class="wishlist-data-information-moved-message">
                    <p id="information-wishlist-notification">Moved successfully</p>
                </div>
