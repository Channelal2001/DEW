      ...
      <section id="search">
        ...
        <div id="menu">
          <button class="unstyle" @click="showfriends">
            <svg class="button-menu" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="12" height="12"
                 viewBox="0 0 20 20">
              <path
          ...
          <a href="/chat">
            <svg class="button-menu" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24"
                 viewBox="0 0 64 64">
              <path
          ...
          <a href="/accountManager">
            <svg class="button-account" xmlns="http://www.w3.org/2000/svg" width="8" height="8"
    ...
    <main>
      <div id="hide">
        <div id="friends">
          ...
          <div v-for="friend in friends" :key="friend.id" class="content-friend">
            ...
            <div>
              <img id="image-friend-info" :src="friend.image" alt="friend-image">
            </div>
          </div>
        </div>
      </div>
      <div id="hide-notifications">
        <div id="notification-tab">
          ...
          <div v-for="request in requests" :key="request.id" class="tab-part">
            <div class="profile">
              <img id="image-friend-info" :src="request.image" alt="image-user">
              <p>{{ request.name }}</p>
            </div>
      ...
      <div id="hide-search">
        ...
        <div id="display-wishlists">
          <div @click="showWishlist(wishlist.id)" v-for="wishlist in userWishlists" :key="wishlist.id" id="link-wishlist-user" >
