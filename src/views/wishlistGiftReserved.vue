        ...
        <section class="chats-dashboard">
            <div id="wishlist-product-list">
                ...
                <div class="chat-user-moving">
                    ...
                    <p id="notifications-reserved">Reserved</p>
                </div>
                <div class="chat-user">
                    <img id="image-user" src="/src/assets/images/chat-image-user.png " alt="image-chat-user ">
                    <div id="box-message-gift">
            ...
            <div id="wishlist-information">
                ...
                <div id="wishlist-data-information">
                    ...
                    <div id="navegation-gift">
                        <a href="" id="button-move">Move</a>
                        <a href="/wishlistGift" id="button-delete">Delete</a>
                    </div>
                </div>
                <div class="wishlist-data-information-moved-message-error">
                    <p id="information-wishlist-notification">Gift reserved successfully</p>
                </div>
            </div>
        </section>
    </main>
